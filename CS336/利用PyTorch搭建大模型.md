...
- **公式**：
  - 训练Transformer需要的FLOPs估算
    $ Total \_ FLOPS = 6 \times P \times T $
    - P: number of parameters
    - T: number of tokens
  - 显卡集群的算力估算
    $ Cluster \_ Performance = N \times Pk \times MFU $
    - N: number of GPUs
    - Pk: Peak performance
    - MFU: Model FLOPs Utilization
  - 最终估计时间
    $ Time = \frac{Total \_ FLOPS}{Cluster \_ Performance}$
- 假定 MFU =50% peak performance = 989T FLOPS
- 答案：
  $ Time =\frac{6 \times 7 \times 10^{10} \times 15 \times 10^{12}}{1024 \times 0.5 \times 989 \times 10^{12}} \approx 12441544 \  S \approx 144 \  D $
...
- 答案：
  $ Num\_Parameters = \frac{80 \times 10 \times 10^9}{16} = 4 \times 10^{10} $
