...
$$
r = \{ \{10101, Srinivasan, Comp. Sci.\}, \{12121, Wu, Finance\}, \{15151, Mozart, Music\}, \{22222, Einstein, Physics\} \}
$$
$$
\begin{array}{|l|l|l|}
\hline
\mathbf{ID} & \mathbf{Name} & \mathbf{Dept\_Name} \\ \hline
10101 & \text{Srinivasan} & \text{Comp. Sci.} \\ \hline
12121 & \text{Wu} & \text{Finance} \\ \hline
15151 & \text{Mozart} & \text{Music} \\ \hline
22222 & \text{Einstein} & \text{Physics} \\ \hline
\end{array}
$$
